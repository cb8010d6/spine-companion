...
5. Verify by asking the tool to call `companion_report_ai_phase` or by posting:
...
- Other tools: use Manager > AI Integrations, the local HTTP API, or copy the MCP server entry from `references/mcp-configs.md`.
